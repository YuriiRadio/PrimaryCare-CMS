...
function debug($array, $stop = false) {
...
/**
* Function Clear string from tags.
*
* @param string $inputString
* @return string
* @author Yurii Radio
...
function safeString($inputString) {
    ...
    //$inputString = str_replace($quotes, '', $inputString);
    $inputString = preg_replace("/https?:\/\/(www\.)?/i", "", $inputString);
    //$inputString = preg_replace("/@|&|\//i", "", $inputString);
    $inputString = preg_replace("/@/i", "{DOG}", $inputString);
    return $inputString;
}
